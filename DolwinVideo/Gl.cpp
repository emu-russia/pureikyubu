...
// forward reference
void GL_EndFrame();
void GL_DoSnapshot(BOOL sel, FILE *f, u8 *dst, int width, int height);

// optionable
static u32  scr_w = 640, scr_h = 480;

// perfomance counters
static u32  frames, tris, pts, lines;
...
// set clear rules
static void GL_SetClear(Color clr, u32 z)
{
    cr = clr.R;
    cg = clr.G;
    cb = clr.B;
