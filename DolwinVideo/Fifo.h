...
extern u8  accum[1024*1024+32];// primitive accumulation buffer
extern u8 *accptr;             // current offset in accum
extern u32 acclen;             // length of accumulated data
extern u8  cmdidle;
