...
void DoLights(const Vertex *v)
{
    ...
    // write back result
    rasca[0].R = (u8)(res[0] * 255.0f);
    rasca[0].G = (u8)(res[1] * 255.0f);
    rasca[0].B = (u8)(res[2] * 255.0f);
    ...
    // write back result
    rasca[1].R = (u8)(res[0] * 255.0f);
    rasca[1].G = (u8)(res[1] * 255.0f);
    rasca[1].B = (u8)(res[2] * 255.0f);
