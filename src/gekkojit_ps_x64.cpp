...
Paired-Single -> SSE/SSE2 recompiler (x86-64). See gekkojit_ps.h for the design
notes; gekkojit_ps_x86.cpp is the 32-bit sibling of this file.
...
// instruction stays on the interpreter fallback. This is the module that owns the
// stub whenever the 32-bit one is not in the build.
namespace Gekko
{
	namespace JitPs
	{
