...
|One or more byte instructions|AAA, AAD, AAM, AAS, CBW, CDQ, CDQE, CLC, CLD, CLI, CLTS, CMC, CMPS/CMPSB/CMPSW/CMPSD, CPUID, CQO, CWD, CWDE, DAA, DAS, HLT, INS, INT 3, INTO, INVD, IRET/IRETD, LAHF, LEAVE, LODS/LODSB/LODSW/LODSD, MOVS/MOVSB/MOVSW/MOVSD, NOP, OUTS, POPA/POPAD, POPF/POPFD/POPFQ, PUSHA/PUSHAD, PUSHF/PUSHFD, RDMSR, RDPMC, RDTSC, RDTSCP, RSM, SAHF, SCAS/SCASB/SCASW/SCASD, STC, STD, STI, STOS/STOSB/STOSW/STOSD, SWAPGS, SYSCALL, SYSRET, UD0, UD1, UD2, WAIT, WBINVD, WRMSR, XLAT/XLATB|
