...
```
8000 00 92 00 FF 	lri  	bank, #0x00FF
8002 12 06       	sbset	12
8003 12 02       	sbset	8
8004 12 03       	sbset	9
8005 12 04       	sbset	10
...
8069 02 BF 80 78 	call 	$0x8078
806B 81 00       	clr  	ac0             	     	
806C 26 FF       	lrs  	ac0.m, $(CMBL)
806D 1C 1E       	mrr  	ar0, ac0.m
806E 02 9F 80 B5 	j    	$0x80B5
8070 00 21       	halt 	
8071 16 FC FA AA 	si   	$(DMBH), #0xFAAA
8073 2E FD       	srs  	$(DMBL), ac0.m
8074 02 BF 80 7E 	call 	$0x807E
8076 02 9F 80 0E 	j    	$0x800E
8078 26 FE       	lrs  	ac0.m, $(CMBH)
8079 02 C0 80 00 	tset 	ac0.m, #0x8000
807B 02 9C 80 78 	jnok 	$0x8078
807D 02 DF       	ret  	
807E 26 FC       	lrs  	ac0.m, $(DMBH)
807F 02 A0 80 00 	tclr 	ac0.m, #0x8000
8081 02 9C 80 7E 	jnok 	$0x807E
8083 02 DF       	ret  	
8084 00 21       	halt 	
8085 8E 00       	clr40	                	     	
8086 81 00       	clr  	ac0             	     	
8087 1F D9       	mrr  	ac0.m, ax1.l
8088 B1 00       	tst  	ac0             	     	
8089 02 95 80 9D 	jeq  	$0x809D
808B 00 FA FF CE 	sr   	$(DSMAH), ax0.h
...
8095 00 F9 FF CB 	sr   	$(DSBL), ax1.l
...
8562 29 D1       	srs  	$(ACFMT), ax1.l
8563 29 D4       	srs  	$(ACSAH), ax1.l
8564 29 D5       	srs  	$(ACSAL), ax1.l
...
85B7 16 D1 00 05 	si   	$(ACFMT), #0x0005
...
861E 14 6D       	lsr  	ac0, -19
861F 1F 5E       	mrr  	ax0.h, ac0.m
8620 04 E0       	addis	ac0.m, -32
8621 6C 1E       	mov  	ac0, ac1        	mv   	ax1.h, ac0.m
8622 1C 66       	mrr  	ar3, ix2
8623 34 86       	andr 	ac0.m, ax0.h    	dr   	ar2
8624 37 86       	andr 	ac1.m, ax1.h    	dr   	ar2
8625 4C 52       	add  	ac0, ac1        	l    	ax0.h, @ar2
...
862B 33 D2       	xorr 	ac1.m, ax1.h    	l    	ax0.h, @ar2
...
8633 33 9A       	xorr 	ac1.m, ax1.h    	mv   	ax0.h, ac0.m
...
863A F5 57       	lsr16	ac1             	ln   	ax0.h, @ar3
...
865A 29 D1       	srs  	$(ACFMT), ax1.l
865B 29 D4       	srs  	$(ACSAH), ax1.l
865C 29 D5       	srs  	$(ACSAL), ax1.l
...
86BE 79 00       	decm 	ac1             	     	
86BF 15 7F       	lsr  	ac1, -1
86C0 1F 3F       	mrr  	ax1.l, ac1.m
86C1 19 9D       	lrrn 	ac1.l, @ar0
86C2 19 9A       	lrrn 	ax0.h, @ar0
86C3 1C 65       	mrr  	ar3, ix1
86C4 00 79 86 CF 	bloop	ax1.l, $0x86CF
86C6 02 BF 86 E5 	call 	$0x86E5
86C8 1F B9       	mrr  	ac1.l, ax1.l
86C9 1F 46       	mrr  	ax0.h, ix2
86CA 1C 65       	mrr  	ar3, ix1
86CB 02 BF 86 E5 	call 	$0x86E5
86CD 1F B9       	mrr  	ac1.l, ax1.l
86CE 1F 46       	mrr  	ax0.h, ix2
...
8711 33 D2       	xorr 	ac1.m, ax1.h    	l    	ax0.h, @ar2
...
8719 33 9E       	xorr 	ac1.m, ax1.h    	mv   	ax1.h, ac0.m
...
8720 F5 57       	lsr16	ac1             	ln   	ax0.h, @ar3
...
8729 00 92 00 FF 	lri  	bank, #0x00FF
872B 00 DF 04 03 	lr   	ac1.m, $0x0403
872D F5 00       	lsr16	ac1             	     	
872E 29 C9       	srs  	$(DSCR), ax1.l
...
873A 29 D1       	srs  	$(ACFMT), ax1.l
873B 29 D4       	srs  	$(ACSAH), ax1.l
873C 29 D5       	srs  	$(ACSAL), ax1.l
...
8822 29 D1       	srs  	$(ACFMT), ax1.l
8823 29 D4       	srs  	$(ACSAH), ax1.l
8824 29 D5       	srs  	$(ACSAL), ax1.l
...
88BC 19 DA       	lrrn 	ax0.h, @ar2
88BD 48 56       	addax	ac0, ax0        	ln   	ax0.h, @ar2
88BE 1F FC       	mrr  	ac1.m, ac0.l
88BF 31 56       	xorr 	ac1.m, ax0.h    	ln   	ax0.h, @ar2
...
88C7 14 6D       	lsr  	ac0, -19
88C8 1F 5E       	mrr  	ax0.h, ac0.m
88C9 04 E0       	addis	ac0.m, -32
88CA 00 1F       	addarn	ar3, ix3
88CB 6C 1E       	mov  	ac0, ac1        	mv   	ax1.h, ac0.m
88CC 34 85       	andr 	ac0.m, ax0.h    	dr   	ar1
88CD 37 D9       	andr 	ac1.m, ax1.h    	l    	ax1.h, @ar1
88CE 4C 52       	add  	ac0, ac1        	l    	ax0.h, @ar2
88CF 48 53       	addax	ac0, ax0        	l    	ax0.h, @ar3
88D0 1B DC       	srrn 	@ar2, ac0.l
88D1 1B 5E       	srri 	@ar2, ac0.m
88D2 32 5F       	xorr 	ac0.m, ax1.h    	ln   	ax1.h, @ar3
88D3 30 51       	xorr 	ac0.m, ax0.h    	l    	ax0.h, @ar1
88D4 00 0A       	iar  	ar2
