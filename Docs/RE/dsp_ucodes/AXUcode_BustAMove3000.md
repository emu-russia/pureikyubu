...
- Register ar0 stores the current pointer in the command list (starting address 0xC00)
- Most of the information on data structure formats was obtained from the ax.h header from the Dolphin SDK

## Example Command List

Example command list packet (staring from command 0x0000)
...
A command list is generated by the AXCL.c component of the AX library. When the previous AI DMA ends, the AXCL generates a list of commands for the next frame
and starts playing the current frame. That is, the playback of frames occurs with an overhead: while one frame is being prepared on the DSP side, 
the old one is played at that time through AI DMA. The size of one frame is 640 bytes.
...
0000 00 00       	nop  	
0001 00 00       	nop  	
0002 02 9F 0E B3 	j    	$0x0EB3 			// Stack Overflow + Reset
0004 02 9F 0E C2 	j    	$0x0EC2 			// Unk2  
0006 02 9F 0E DE 	j    	$0x0EDE  			// Unk3   (Accelerator related?)
0008 02 9F 0E ED 	j    	$0x0EED 			// Unk4 Rti
000A 02 9F 0E F3 	j    	$0x0EF3 			// ACCOV 
000C 02 9F 0F 25 	j    	$0x0F25 			// Unk6 Rti
000E 02 9F 0F 2B 	j    	$0x0F2B 			// INT Rti
```
...
0016 8C 00       	clr15	                	     	
0017 8B 00       	m0   	                	     	
0018 00 92 00 FF 	lri  	config, #0x00FF
001A 81 00       	clr  	ac0             	     	
001B 89 00       	clr  	ac1             	     	
001C 00 9E 0E 80 	lri  	ac0.m, #0x0E80
001E 00 FE 0E 1B 	sr   	$0x0E1B, ac0.m 			// Dmem_0E1B = 0xE80
0020 81 00       	clr  	ac0             	     	
0021 00 FE 0E 31 	sr   	$0x0E31, ac0.m 			// Dmem_0E31 = 0
0023 16 FC DC D1 	si   	$(DMBH), #0xDCD1 			// DspMailbox = 0xDCD10000 - Hello
0025 16 FD 00 00 	si   	$(DMBL), #0x0000
0027 16 FB 00 01 	si   	$(DIRQ), #0x0001  				// CPU Interrupt   (DSP ready for another command packet)
0029 26 FC       	lrs  	ac0.m, $(DMBH)  		// Wait Cpu read Dsp mailbox
...
0036 8C 00       	clr15	                	     	
0037 8B 00       	m0   	                	     	
0038 00 92 00 FF 	lri  	config, #0x00FF
003A 16 FC DC D1 	si   	$(DMBH), #0xDCD1 		// DspMailbox = 0xDCD10001 	- Ready
003C 16 FD 00 01 	si   	$(DMBL), #0x0001
003E 16 FB 00 01 	si   	$(DIRQ), #0x0001 			// CPU Interrupt   (DSP ready for another command packet)
...
0046 81 00       	clr  	ac0             	     	
0047 89 00       	clr  	ac1             	     	
0048 00 9F BA BE 	lri  	ac1.m, #0xBABE  		// CpuMailbox: 0xBABE_[size]
004A 26 FE       	lrs  	ac0.m, $(CMBH)
004B 02 C0 80 00 	tset 	ac0.m, #0x8000
004D 02 9C 00 4A 	jnok 	$0x004A
004F 82 00       	cmp 							// size != 0
0050 02 94 00 4A 	jne  	$0x004A
0052 23 FF       	lrs  	ax1.h, $(CMBL) 			// Dmem block size
0053 81 00       	clr  	ac0             	     	
0054 26 FE       	lrs  	ac0.m, $(CMBH) 			// Wait another Cpu message: MainMemAddress
...
005C 2E CE       	srs  	$(DSMAH), ac0.m   		// DSMA = MainMemAddress & 0x7FFFFFFF
005D 2F CF       	srs  	$(DSMAL), ac1.m
005E 16 CD 0C 00 	si   	$(DSPA), #0x0C00 		// Dmem 0x0C00 (save command list)
0060 81 00       	clr  	ac0             	     	
0061 2E C9       	srs  	$(DSCR), ac0.m 			// Mode: 0 (MMEM -> DSP, DMEM)
...
006B B1 00       	tst  	ac0             	     	
006C 02 91 00 7E 	jl   	$0x007E  			// CmdBlock.Ushort0 < 0
006E 0A 13       	lris 	ax1.l, 19 					// ax1.l = 19
006F C1 00       	cmpar	ac0.m, ax1.l 			// ac0.m > 19 ?
0070 02 92 00 7E 	jg   	$0x007E
0072 00 9F 0C C8 	lri  	ac1.m, #0x0CC8  			// Jump Table 1
0074 4C 00       	add  	ac0, ac1        	     	
0075 1C 7E       	mrr  	ar3, ac0.m
0076 02 13       	ilrr 	ac0.m, @ar3
0077 1C 7E       	mrr  	ar3, ac0.m
0078 17 6F       	jmpr 	ar3  					// Jump  JumpTable1[CmdBlock.Ushort0]
...
```
0082 8D 00       	set15	            			// Operands are signed (1 = unsigned)
0083 8F 00       	set40	                	     // Sign extension mode (0 = set16, 1 = set40) 	
0084 8A 00       	m2   	                	     	
0085 89 00       	clr  	ac1             	     	
0086 81 68       	clr  	ac0             	l    	ac1.l, @ar0 				// ac1l = Param[0]   (0x8000)
0087 00 98 00 00 	lri  	ax0.l, #0x0000  					// bool msb = 0
0089 00 99 00 01 	lri  	ax0.h, #0x0001 					 		// true
008B 00 81 00 00 	lri  	ar1, #0x0000 						// Sample Buffer 0
008D 00 00       	nop  	
008E 19 3E       	lrri 	ac0.m, @ar1 				// ac0.m = *ar1++; 		Sign extend m to h
008F 19 3C       	lrri 	ac0.l, @ar1 				// ac0.l = *ar1++;
0090 11 A0 00 9B 	bloopi	#0xA0, $0x009B
	0092 A1 00       	abs  	ac0             	     	
	0093 82 71       	cmp  	                	l    	ac0.m, @ar1
	0094 02 77       	ifc  	   				// If Below
	0095 1F 19       	mrr  	ax0.l, ax0.h 			// msb = 1
	0096 19 3C       	lrri 	ac0.l, @ar1
	0097 A1 00       	abs  	ac0             	     	
	0098 82 71       	cmp  	                	l    	ac0.m, @ar1
	0099 02 77       	ifc  	  				// If Below
	009A 1F 19       	mrr  	ax0.l, ax0.h 			// msb = 1
	009B 19 3C       	lrri 	ac0.l, @ar1
009C 1F D8       	mrr  	ac0.m, ax0.l 				// ac0m = msb    Sign extend m to h
009D B1 00       	tst  	ac0             	     	
...
00A6 19 1C       	lrri 	ac0.l, @ar0 				// Skip other parameters
00A7 19 1C       	lrri 	ac0.l, @ar0
00A8 19 1C       	lrri 	ac0.l, @ar0
00A9 00 E0 0E 45 	sr   	$0x0E45, ar0 					// Save ar0
...
00D0 00 99 01 40 	lri  	ax0.h, #0x0140
00D2 00 00       	nop  	
00D3 A0 00       	mulx 	ax0.l, ax1.l    	  			// Last known value = 19 (From Main)  
00D4 19 1E       	lrri 	ac0.m, @ar0
00D5 00 00       	nop  	
00D6 00 FE 0E 44 	sr   	$0x0E44, ac0.m
00D8 19 1E       	lrri 	ac0.m, @ar0
00D9 19 1C       	lrri 	ac0.l, @ar0
00DA 00 E0 0E 45 	sr   	$0x0E45, ar0 				// Save ar0
00DC 4E 00       	addp 	ac0             	     	
...
00E9 8A 48       	m2   	                	l    	ax0.h, @ar0
00EA 00 83 0E 48 	lri  	ar3, #0x0E48 								// Temp Buf
00EC 00 80 00 00 	lri  	ar0, #0x0000
00EE 00 81 00 00 	lri  	ar1, #0x0000
00F0 19 79       	lrri 	ax0.h, @ar3
00F1 19 3A       	lrri 	ax1.l, @ar1
00F2 B0 41       	mulx 	ax0.h, ax1.l    	l    	ax0.l, @ar1
00F3 A6 4B       	mulxmv	ax0.l, ax1.l, ac0	l    	ax0.h, @ar3
00F4 F0 51       	lsl16	ac0             	l    	ax1.l, @ar1
00F5 B4 41       	mulxac	ax0.h, ax1.l, ac0	l    	ax0.l, @ar1
00F6 91 00       	asr16	ac0             	     	
00F7 11 50 01 00 	bloopi	#0x50, $0x0100
	00F9 A7 92       	mulxmv	ax0.l, ax1.l, ac1	sl   	ac0.m, ax0.h
	00FA F1 51       	lsl16	ac1             	l    	ax1.l, @ar1
	00FB B5 20       	mulxac	ax0.h, ax1.l, ac1	s    	@ar0, ac0.l
	00FC 99 41       	asr16	ac1             	l    	ax0.l, @ar1
	00FD A6 93       	mulxmv	ax0.l, ax1.l, ac0	sl   	ac1.m, ax0.h
	00FE F0 51       	lsl16	ac0             	l    	ax1.l, @ar1
	00FF B4 28       	mulxac	ax0.h, ax1.l, ac0	s    	@ar0, ac1.l
	0100 91 41       	asr16	ac0             	l    	ax0.l, @ar1
0101 00 83 0E 48 	lri  	ar3, #0x0E48 									// Temp Buf
0103 00 80 01 40 	lri  	ar0, #0x0140
0105 00 81 01 40 	lri  	ar1, #0x0140
0107 19 79       	lrri 	ax0.h, @ar3
0108 19 3A       	lrri 	ax1.l, @ar1
0109 B0 41       	mulx 	ax0.h, ax1.l    	l    	ax0.l, @ar1
010A A6 4B       	mulxmv	ax0.l, ax1.l, ac0	l    	ax0.h, @ar3
010B F0 51       	lsl16	ac0             	l    	ax1.l, @ar1
010C B4 41       	mulxac	ax0.h, ax1.l, ac0	l    	ax0.l, @ar1
010D 91 00       	asr16	ac0             	     	
010E 11 50 01 17 	bloopi	#0x50, $0x0117
	0110 A7 92       	mulxmv	ax0.l, ax1.l, ac1	sl   	ac0.m, ax0.h
	0111 F1 51       	lsl16	ac1             	l    	ax1.l, @ar1
	0112 B5 20       	mulxac	ax0.h, ax1.l, ac1	s    	@ar0, ac0.l
	0113 99 41       	asr16	ac1             	l    	ax0.l, @ar1
	0114 A6 93       	mulxmv	ax0.l, ax1.l, ac0	sl   	ac1.m, ax0.h
	0115 F0 51       	lsl16	ac0             	l    	ax1.l, @ar1
	0116 B4 28       	mulxac	ax0.h, ax1.l, ac0	s    	@ar0, ac1.l
	0117 91 41       	asr16	ac0             	l    	ax0.l, @ar1

0118 00 C0 0E 45 	lr   	ar0, $0x0E45 								// Restore ar0
...
0123 2E CD       	srs  	$(DSPA), ac0.m 			// Dsp Dmem 0xE48
0124 0E 00       	lris 	ac0.m, 0
0125 2E C9       	srs  	$(DSCR), ac0.m 			// Mode: 0 (MMEM -> DSP, DMEM)
0126 00 9E 00 40 	lri  	ac0.m, #0x0040
0128 2E CB       	srs  	$(DSBL), ac0.m 			// Block size 0x40
0129 00 81 0E 48 	lri  	ar1, #0x0E48
012B 00 82 00 00 	lri  	ar2, #0x0000  		
012D 00 9B 00 9F 	lri  	ax1.h, #0x009F
012F 00 9A 01 40 	lri  	ax1.l, #0x0140
0131 81 00       	clr  	ac0             	     	
0132 89 00       	clr  	ac1             	     	
0133 8F 00       	set40	                	     	
0134 02 BF 06 94 	call 	$0x0694 				// WaitDspDma
0136 19 3E       	lrri 	ac0.m, @ar1 				// Parse 0xE48 block  -> Dmem 0x0000
0137 19 3C       	lrri 	ac0.l, @ar1
0138 B1 00       	tst  	ac0             	     	
0139 19 3F       	lrri 	ac1.m, @ar1
013A 02 94 01 40 	jne  	$0x0140
013C 00 5A       	loop 	ax1.l
...
Example 0xE48 Dma contents:

```
0E48 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
0E58 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
0E68 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
0E78 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
```
...
01DC 8E 48       	clr40	                	l    	ax0.h, @ar0
01DD 00 FA 0E 17 	sr   	$0x0E17, ax1.l
01DF 00 F8 0E 18 	sr   	$0x0E18, ax0.l
01E1 00 81 00 00 	lri  	ar1, #0x0000
01E3 02 BF 06 29 	call 	$0x0629 					// Command1_Sub1
01E5 00 DA 0E 17 	lr   	ax1.l, $0x0E17
01E7 00 D8 0E 18 	lr   	ax0.l, $0x0E18
01E9 89 48       	clr  	ac1             	l    	ax0.h, @ar0
01EA 00 81 04 00 	lri  	ar1, #0x0400
01EC 02 BF 06 29 	call 	$0x0629 					// Command1_Sub1
01EE 00 DA 0E 17 	lr   	ax1.l, $0x0E17 
01F0 00 D8 0E 18 	lr   	ax0.l, $0x0E18
01F2 89 48       	clr  	ac1             	l    	ax0.h, @ar0
...
0207 16 C9 00 01 	si   	$(DSCR), #0x0001 		// DRAM -> MMEM
...
0214 16 CD 0E 48 	si   	$(DSPA), #0x0E48 			// 0xE48
0216 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
0218 89 00       	clr  	ac1             	     	
0219 0D 20       	lris 	ac1.l, 32 					// 32 bytes
021A 2D CB       	srs  	$(DSBL), ac1.l
021B 4C 00       	add  	ac0, ac1        	     	
021C 1C 80       	mrr  	ix0, ar0 				// Save ar0
...
022D 16 CD 0E 58 	si   	$(DSPA), #0x0E58 			// 0xE58
022F 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
0231 16 CB 02 60 	si   	$(DSBL), #0x0260 			// 0x260 bytes
0233 00 9F 00 A0 	lri  	ac1.m, #0x00A0
0235 8F 00       	set40	                	     	
0236 00 7F 02 3F 	bloop	ac1.m, $0x023F 			// count: 0xA0
0238 19 7E       	lrri 	ac0.m, @ar3
0239 1B 1A       	srri 	@ar0, ax1.l
023A 19 7C       	lrri 	ac0.l, @ar3
023B 1B 1A       	srri 	@ar0, ax1.l
023C 1B 5E       	srri 	@ar2, ac0.m
023D 7C 22       	neg  	ac0             	s    	@ar2, ac0.l
023E 1B 3E       	srri 	@ar1, ac0.m
023F 1B 3C       	srri 	@ar1, ac0.l
0240 1C 04       	mrr  	ar0, ix0 				// Restore ar0
...
Command_0x11() 			// 020F
{
	...
	DmaMmemDram (MmemHi, MmemLo, 0xE48, 32);
	WaitDspDma();

	DmaMmemDram (MmemHi, MmemLo + 32, 0xE58, 0x0260);

	// Total Dma size 0x280 bytes
	...
	// Save with partially changing the sign in one array and with a change in sign (NEG) in another 2 arrays. Clear array 0x280
...
027E 02 BF 06 94 	call 	$0x0694 				// WaitDspDma
0280 00 DE 0B A7 	lr   	ac0.m, $0x0BA7 					 // Mmem Address: [0x0BA7] [0x0BA8]   (from Dma above)
...
0295 00 FE 0E 15 	sr   	$0x0E15, ac0.m 				// *0xE15 = JumpTable5[n]
0297 00 DE 0B 85 	lr   	ac0.m, $0x0B85
0299 00 9F 0D 4F 	lri  	ac1.m, #0x0D4F 				// Coef Table
...
02C1 00 FE 0E 47 	sr   	$0x0E47, ac0.m 				// *0xE47 = JumpTable4[n]
02C3 81 00       	clr  	ac0             	     	
02C4 00 DE 0B 9B 	lr   	ac0.m, $0x0B9B  			// if (*0x0B9B != 0) 		AXPBITDBUFFER
02C6 B1 00       	tst  	ac0             	     	
02C7 02 95 02 EE 	jeq  	$0x02EE  		
	...
	02DC 02 BF 06 94 	call 	$0x0694 					// WaitDspDma  (0x80 bytes)
	02DE 00 DE 0B 9C 	lr   	ac0.m, $0x0B9C
	02E0 2E CE       	srs  	$(DSMAH), ac0.m
	02E1 00 DE 0B 9D 	lr   	ac0.m, $0x0B9D
	02E3 2E CF       	srs  	$(DSMAL), ac0.m
	02E4 16 CD 0C C0 	si   	$(DSPA), #0x0CC0 			// Dmem 0xCC0
	02E6 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
	02E8 16 CB 00 40 	si   	$(DSBL), #0x0040 			// 0x40 bytes
	02EA 02 BF 06 94 	call 	$0x0694 					// WaitDspDma
...
```
8019712C  80 19 72 18 80 19 71 2C  00 00 00 00 00 00 00 00
8019713C  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
```

```
80197218  80 19 73 04 80 19 72 18  00 00 00 00 00 00 00 00
80197228  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
```

```
80197304  80 19 73 F0 80 19 73 04  00 00 00 00 00 00 00 00
80197314  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
```

Dma logs:

```
DSP: DspCore::Dma: Mmem: 0x00197040, DspAddr: 0x0B80, Size: 0x00D0, Ctrl: 0
```
...
0555 16 C9 00 01 	si   	$(DSCR), #0x0001 			// DRAM -> MMEM
...
0569 16 C9 00 01 	si   	$(DSCR), #0x0001 			// DRAM -> MMEM
...
057A 16 CD 02 80 	si   	$(DSPA), #0x0280 			// Dmem 0x280
057C 16 C9 00 01 	si   	$(DSCR), #0x0001  			// DRAM -> MMEM
057E 16 CB 02 80 	si   	$(DSBL), #0x0280 		// 640 bytes
0580 8F 50       	set40	                	l    	ax1.l, @ar0
0581 81 40       	clr  	ac0             	l    	ax0.l, @ar0
0582 00 81 04 00 	lri  	ar1, #0x0400
0584 00 83 00 00 	lri  	ar3, #0x0000 				// ar3 = Dmem 0x0000
0586 00 82 01 40 	lri  	ar2, #0x0140 				// ar2 = Dmem 0x0140
0588 00 99 00 80 	lri  	ax0.h, #0x0080
058A 02 BF 06 94 	call 	$0x0694 					// WaitDspDma
058C 11 05 05 A4 	bloopi	#0x05, $0x05A4
	...
	059B 1F FB       	mrr  	ac1.m, ax1.h  			// Dmem 0x400 ...
	059C 2F CD       	srs  	$(DSPA), ac1.m
	059D 0F 01       	lris 	ac1.m, 1
	059E 2F C9       	srs  	$(DSCR), ac1.m 				// DRAM -> MMEM
	059F 1F F9       	mrr  	ac1.m, ax0.h 			// 0x80 bytes
	05A0 2F CB       	srs  	$(DSBL), ac1.m
	05A1 72 00       	addaxl	ac0, ax1.l     	     	
	05A2 1F 5E       	mrr  	ax1.l, ac0.m
	05A3 1F 1C       	mrr  	ax0.l, ac0.l
	05A4 81 00       	clr  	ac0             	     	
05A5 26 C9       	lrs  	ac0.m, $(DSCR) 			// Wait Dma
...
05C7 2E C9       	srs  	$(DSCR), ac0.m 					// MMEM -> DRAM
05C8 81 00       	clr  	ac0             	     	
05C9 00 9C 00 C0 	lri  	ac0.l, #0x00C0
05CB 2C CB       	srs  	$(DSBL), ac0.l 				// 0xC0 Bytes
...
05D3 00 99 00 60 	lri  	ax0.h, #0x0060
...
05ED 16 C9 00 00 	si   	$(DSCR), #0x0000 				// MMEM -> DRAM
05EF 81 00       	clr  	ac0             	     	
05F0 00 9C 00 C0 	lri  	ac0.l, #0x00C0
05F2 2C CB       	srs  	$(DSBL), ac0.l 			// 0xC0 bytes
...
0635 89 00       	clr  	ac1             	     	
0636 02 BF 06 94 	call 	$0x0694 					// WaitDspDma
0638 11 04 06 64 	bloopi	#0x04, $0x0664
063A 00 DA 0E 1D 	lr   	ax1.l, $0x0E1D
...
064D 89 00       	clr  	ac1             	     	
064E 00 DA 0E 1D 	lr   	ax1.l, $0x0E1D
...
0663 8E 00       	clr40	                	     	
0664 89 00       	clr  	ac1             	     	
0665 00 DA 0E 1D 	lr   	ax1.l, $0x0E1D
...
06B1 16 CD 0E 48 	si   	$(DSPA), #0x0E48 			// 0xE48
06B3 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
06B5 89 00       	clr  	ac1             	     	
06B6 0D 20       	lris 	ac1.l, 32
06B7 2D CB       	srs  	$(DSBL), ac1.l 				// 32 bytes
06B8 4C 00       	add  	ac0, ac1        	     	
06B9 1C 80       	mrr  	ix0, ar0 					// Save ar0
...
06C2 0A 00       	lris 	ax1.l, 0
06C3 27 C9       	lrs  	ac1.m, $(DSCR) 				// Wait Dma
06C4 03 A0 00 04 	tclr 	ac1.m, #0x0004
06C6 02 9C 06 C3 	jnok 	$0x06C3
06C8 2E CE       	srs  	$(DSMAH), ac0.m
06C9 2C CF       	srs  	$(DSMAL), ac0.l 				// MmemAddr + 32
06CA 16 CD 0E 58 	si   	$(DSPA), #0x0E58 			// 0xE58
06CC 16 C9 00 00 	si   	$(DSCR), #0x0000  			// MMEM -> DRAM
06CE 16 CB 02 60 	si   	$(DSBL), #0x0260 		// 0x260 bytes
06D0 00 9F 00 A0 	lri  	ac1.m, #0x00A0
06D2 8F 00       	set40	                	     	
06D3 00 7F 06 DC 	bloop	ac1.m, $0x06DC 				// Wait Dma? :p
06D5 19 7E       	lrri 	ac0.m, @ar3  		// ac0m = *ar3++;
06D6 1B 1A       	srri 	@ar0, ax1.l  		// *ar0++ = 0;
06D7 19 7C       	lrri 	ac0.l, @ar3 		// ac0l = *ar3++;
06D8 1B 1A       	srri 	@ar0, ax1.l 		// *ar0++ = 0;
06D9 1B 5E       	srri 	@ar2, ac0.m 		// *ar2++ = ac0m;
06DA 1B 5C       	srri 	@ar2, ac0.l 		// *ar2++ = ac0l;
06DB 1B 3E       	srri 	@ar1, ac0.m 		// *ar1++ = ac0m;
...
```
80192CE0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
80192CF0  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
80192D00  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
80192D10  00 00 00 00 00 00 00 00  00 00 00 00 00 00 00 00
```

(no sound lol :P)

Dma logs (0x280 = 640 bytes in total):

```
DSP: DspCore::Dma: Mmem: 0x00192CE0, DspAddr: 0x0E48, Size: 0x0020, Ctrl: 0
DSP: DspCore::Dma: Mmem: 0x00192D00, DspAddr: 0x0E58, Size: 0x0260, Ctrl: 0
```

## -----------------------------------------------------------------------------------------------------------------

## Sample Rate Converters (using Accelerator)
...
06F1 2E A0       	srs  	$(UnkHW_FFA0), ac0.m 					// AXPBADPCM.a[0][0]
06F2 19 5E       	lrri 	ac0.m, @ar2
06F3 2E A1       	srs  	$(UnkHW_FFA1), ac0.m
06F4 19 5E       	lrri 	ac0.m, @ar2
06F5 2E A2       	srs  	$(UnkHW_FFA2), ac0.m
06F6 19 5E       	lrri 	ac0.m, @ar2
06F7 2E A3       	srs  	$(UnkHW_FFA3), ac0.m
06F8 19 5E       	lrri 	ac0.m, @ar2
06F9 2E A4       	srs  	$(UnkHW_FFA4), ac0.m
06FA 19 5E       	lrri 	ac0.m, @ar2
06FB 2E A5       	srs  	$(UnkHW_FFA5), ac0.m
06FC 19 5E       	lrri 	ac0.m, @ar2
06FD 2E A6       	srs  	$(UnkHW_FFA6), ac0.m
06FE 19 5E       	lrri 	ac0.m, @ar2
06FF 2E A7       	srs  	$(UnkHW_FFA7), ac0.m
0700 19 5E       	lrri 	ac0.m, @ar2
0701 2E A8       	srs  	$(UnkHW_FFA8), ac0.m
0702 19 5E       	lrri 	ac0.m, @ar2
0703 2E A9       	srs  	$(UnkHW_FFA9), ac0.m
0704 19 5E       	lrri 	ac0.m, @ar2
0705 2E AA       	srs  	$(UnkHW_FFAA), ac0.m
0706 19 5E       	lrri 	ac0.m, @ar2
0707 2E AB       	srs  	$(UnkHW_FFAB), ac0.m
0708 19 5E       	lrri 	ac0.m, @ar2
0709 2E AC       	srs  	$(UnkHW_FFAC), ac0.m
070A 19 5E       	lrri 	ac0.m, @ar2
070B 2E AD       	srs  	$(UnkHW_FFAD), ac0.m
070C 19 5E       	lrri 	ac0.m, @ar2
070D 2E AE       	srs  	$(UnkHW_FFAE), ac0.m
070E 19 5E       	lrri 	ac0.m, @ar2
070F 2E AF       	srs  	$(UnkHW_FFAF), ac0.m
...
071E 19 59       	lrri 	ax0.h, @ar2 					// AXPBSRC.ratioLo
071F 81 00       	clr  	ac0             	     	
...
076D 00 82 0B D2 	lri  	ar2, #0x0BD2  					// Save last accelerator state to VPB
...
077E 00 82 0D 80 	lri  	ar2, #0x0D80  					// Do some fun
...
07A6 2E A0       	srs  	$(UnkHW_FFA0), ac0.m
07A7 19 5E       	lrri 	ac0.m, @ar2
07A8 2E A1       	srs  	$(UnkHW_FFA1), ac0.m
07A9 19 5E       	lrri 	ac0.m, @ar2
07AA 2E A2       	srs  	$(UnkHW_FFA2), ac0.m
07AB 19 5E       	lrri 	ac0.m, @ar2
07AC 2E A3       	srs  	$(UnkHW_FFA3), ac0.m
07AD 19 5E       	lrri 	ac0.m, @ar2
07AE 2E A4       	srs  	$(UnkHW_FFA4), ac0.m
07AF 19 5E       	lrri 	ac0.m, @ar2
07B0 2E A5       	srs  	$(UnkHW_FFA5), ac0.m
07B1 19 5E       	lrri 	ac0.m, @ar2
07B2 2E A6       	srs  	$(UnkHW_FFA6), ac0.m
07B3 19 5E       	lrri 	ac0.m, @ar2
07B4 2E A7       	srs  	$(UnkHW_FFA7), ac0.m
07B5 19 5E       	lrri 	ac0.m, @ar2
07B6 2E A8       	srs  	$(UnkHW_FFA8), ac0.m
07B7 19 5E       	lrri 	ac0.m, @ar2
07B8 2E A9       	srs  	$(UnkHW_FFA9), ac0.m
07B9 19 5E       	lrri 	ac0.m, @ar2
07BA 2E AA       	srs  	$(UnkHW_FFAA), ac0.m
07BB 19 5E       	lrri 	ac0.m, @ar2
07BC 2E AB       	srs  	$(UnkHW_FFAB), ac0.m
07BD 19 5E       	lrri 	ac0.m, @ar2
07BE 2E AC       	srs  	$(UnkHW_FFAC), ac0.m
07BF 19 5E       	lrri 	ac0.m, @ar2
07C0 2E AD       	srs  	$(UnkHW_FFAD), ac0.m
07C1 19 5E       	lrri 	ac0.m, @ar2
07C2 2E AE       	srs  	$(UnkHW_FFAE), ac0.m
07C3 19 5E       	lrri 	ac0.m, @ar2
07C4 2E AF       	srs  	$(UnkHW_FFAF), ac0.m
...
0835 19 9A       	lrrn 	ax1.l, @ar0
0836 54 00       	subr 	ac0, ax1.l      	     	
...
0850 2E A0       	srs  	$(UnkHW_FFA0), ac0.m
0851 19 5E       	lrri 	ac0.m, @ar2
0852 2E A1       	srs  	$(UnkHW_FFA1), ac0.m
0853 19 5E       	lrri 	ac0.m, @ar2
0854 2E A2       	srs  	$(UnkHW_FFA2), ac0.m
0855 19 5E       	lrri 	ac0.m, @ar2
0856 2E A3       	srs  	$(UnkHW_FFA3), ac0.m
0857 19 5E       	lrri 	ac0.m, @ar2
0858 2E A4       	srs  	$(UnkHW_FFA4), ac0.m
0859 19 5E       	lrri 	ac0.m, @ar2
085A 2E A5       	srs  	$(UnkHW_FFA5), ac0.m
085B 19 5E       	lrri 	ac0.m, @ar2
085C 2E A6       	srs  	$(UnkHW_FFA6), ac0.m
085D 19 5E       	lrri 	ac0.m, @ar2
085E 2E A7       	srs  	$(UnkHW_FFA7), ac0.m
085F 19 5E       	lrri 	ac0.m, @ar2
0860 2E A8       	srs  	$(UnkHW_FFA8), ac0.m
0861 19 5E       	lrri 	ac0.m, @ar2
0862 2E A9       	srs  	$(UnkHW_FFA9), ac0.m
0863 19 5E       	lrri 	ac0.m, @ar2
0864 2E AA       	srs  	$(UnkHW_FFAA), ac0.m
0865 19 5E       	lrri 	ac0.m, @ar2
0866 2E AB       	srs  	$(UnkHW_FFAB), ac0.m
0867 19 5E       	lrri 	ac0.m, @ar2
0868 2E AC       	srs  	$(UnkHW_FFAC), ac0.m
0869 19 5E       	lrri 	ac0.m, @ar2
086A 2E AD       	srs  	$(UnkHW_FFAD), ac0.m
086B 19 5E       	lrri 	ac0.m, @ar2
086C 2E AE       	srs  	$(UnkHW_FFAE), ac0.m
086D 19 5E       	lrri 	ac0.m, @ar2
086E 2E AF       	srs  	$(UnkHW_FFAF), ac0.m
...
0BF2 02 BF 80 E7 	call 	$0x80E7 						// Call IROM
...
0CFA 0A 44
0CFB 0A 51
0CFC 08 A0 							// Bogus (ret)
0CFD 09 AD
0CFE 09 B9
0CFF 09 C5
0D00 08 A0 							// Bogus (ret)
0D01 09 D7
0D02 09 E4
0D03 09 F1
0D04 0A 5E
...
0D1A 0B 56
0D1B 0B 63
0D1C 08 A0 							// Bogus (ret)
0D1D 0A BF
0D1E 0A CB
0D1F 0A D7
0D20 08 A0 							// Bogus (ret)
0D21 0A E9
0D22 0A F6
0D23 0B 03
0D24 0B 70
...
Looks like DROM coefficient memory addresses.

Coef. to be used with 4-tap SRC.

```
0D4F 10 00 							// 8KHz low pass response
0D50 12 00 							// 12.8KHz N64 type response
0D51 14 00 							// 16KHz response
```
...
0D5A 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
0D5C 16 CB 01 00 	si   	$(DSBL), #0x0100
0D5E 1F 7E       	mrr  	ax1.h, ac0.m
0D5F 1F 3C       	mrr  	ax0.h, ac0.l
0D60 81 00       	clr  	ac0             	     	
...
0D6C 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
...
0D77 00 89 00 7F 	lri  	r09, #0x007F
...
0DAE 00 89 FF FF 	lri  	r09, #0xFFFF
0DB0 89 00       	clr  	ac1             	     	
0DB1 81 00       	clr  	ac0             	     	
0DB2 8F 00       	set40	                	     	
...
0DD4 16 C9 00 01 	si   	$(DSCR), #0x0001 			// DRAM -> MMEM
0DD6 16 CB 05 00 	si   	$(DSBL), #0x0500
0DD8 02 BF 06 94 	call 	$0x0694 					// WaitDspDma
0DDA 81 00       	clr  	ac0             	     	
...
0DE1 16 C9 00 00 	si   	$(DSCR), #0x0000 			// MMEM -> DRAM
0DE3 89 00       	clr  	ac1             	     	
...
0DF7 16 C9 00 00 	si   	$(DSCR), #0x0000 				// MMEM -> DRAM
...
Copy something from DRAM to MMEM
...
0E4A 16 C9 00 01 	si   	$(DSCR), #0x0001 								// DRAM -> MMEM
0E4C 16 CB 07 80 	si   	$(DSBL), #0x0780
0E4E 02 BF 06 94 	call 	$0x0694 										// WaitDspDma
0E50 81 00       	clr  	ac0             	     	
...
0E57 16 C9 00 01 	si   	$(DSCR), #0x0001 							// DRAM -> MMEM
0E59 16 CB 02 80 	si   	$(DSBL), #0x0280
0E5B 02 BF 06 94 	call 	$0x0694 									// WaitDspDma
0E5D 81 00       	clr  	ac0             	     	
...
0E6E 02 BF 06 94 	call 	$0x0694 									// WaitDspDma
0E70 02 BF 0E 2B 	call 	$0x0E2B 			// DmemCpyAdd
0E72 81 00       	clr  	ac0             	     	
...
0E83 02 BF 06 94 	call 	$0x0694 									// WaitDspDma
0E85 02 BF 0E 2B 	call 	$0x0E2B 			// DmemCpyAdd
0E87 81 00       	clr  	ac0             	     	
...
0E98 02 BF 06 94 	call 	$0x0694 										// WaitDspDma
0E9A 02 BF 0E 2B 	call 	$0x0E2B 			// DmemCpyAdd
0E9C 81 00       	clr  	ac0             	     	
...
0EAD 02 BF 06 94 	call 	$0x0694 									// WaitDspDma
0EAF 02 BF 0E 2B 	call 	$0x0E2B 			// DmemCpyAdd
...
0F35 81 00       	clr  	ac0             	     	
0F36 89 00       	clr  	ac1             	     	
0F37 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
...
0F42 02 9F 00 30 	j    	$0x0030 			// Reply Ready
0F44 00 21       	halt 	


0F45 81 00       	clr  	ac0             	     	
0F46 89 00       	clr  	ac1             	     	
0F47 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
...
0F56 81 00       	clr  	ac0             	     	
0F57 89 00       	clr  	ac1             	     	
0F58 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
...
0F65 81 00       	clr  	ac0             	     	
0F66 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
0F68 26 FF       	lrs  	ac0.m, $(CMBL)
0F69 1C 1E       	mrr  	ar0, ac0.m
0F6A 89 00       	clr  	ac1             	     	
0F6B 02 BF 0F 89 	call 	$0x0F89
0F6D 20 FF       	lrs  	ax0.l, $(CMBL)
0F6E 1F 5F       	mrr  	ax1.l, ac1.m
0F6F 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
0F71 21 FF       	lrs  	ax0.h, $(CMBL)
0F72 02 BF 0F 83 	call 	$0x0F83 				// ReadCpuMessage
0F74 23 FF       	lrs  	ax1.h, $(CMBL)
0F75 26 C9       	lrs  	ac0.m, $(DSCR)
0F76 02 A0 00 04 	tclr 	ac0.m, #0x0004
0F78 02 9C 0F 75 	jnok 	$0x0F75
0F7A 02 9F 80 B5 	j    	$0x80B5  				// LoadRunUcode (ar0)
