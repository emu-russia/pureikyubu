...
Every test passes: **347 of 347**. (The two that compare `build/Data/GBASettings.json` with
...
boot ROM, the CGB WRAM/palette/HDMA bus paths and the sixteen APU tests), the LCD controller (40), the
