...
Build using Visual Studio 2026. To build, open `scripts/VS2026/pureikyubu.sln` and click Build. (A legacy Visual Studio 2022 project is kept in `scripts/VS2022` for reference.)
